...
export const PROGRAMS = [
  {
    ...
    // Card banner crop, as fractions of the square flyer. bannerTop skips the
    // flyer's HABIT and HCL logo strip; the ratio stops just below the tagline
    // so the crop never reaches the body artwork. Both are per plan because
    // the flyers set their title blocks at different heights.
    bannerTop: 0.093,
    bannerRatio: 4.24,
