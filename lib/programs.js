...
export const PROGRAMS = [
  {
    ...
    // Card banner crop. Each flyer's title block ends at a different height,
    // so the ratio is per plan: it stops just below the tagline, leaving the
    // same visual gap in every card and never reaching the body artwork.
    bannerRatio: 3.04,
